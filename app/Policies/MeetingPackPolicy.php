...
/**
 * 面談パック(追加面談購入用SKU)マスタの認可ルール。全操作 admin のみ。
 *
 * 状態(draft/published/archived)に関する遷移可否のロジックはPolicyには持たせず、
 * 各UseCase(PublishAction/ArchiveAction/UnarchiveAction/DestroyAction)側の例外に委ねる。
 */
